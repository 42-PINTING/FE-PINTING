      ...
      <div className={styles.mainContainer}>
        <div className={styles.rightContainer}>
          ...
          <div className={styles.rightMiddleContainer}>
            ...
            <span className={styles.timeText}>{detailData.time}</span>
          ...
          <div className={styles.buttonContainer}>
            <button
              className={styles.imageFixButton}
        ...
        <div className={styles.leftContainer}>
          <div className={styles.leftTopContainer}>
            ...
            <div>
              <div className={styles.hashTagContainer}>
                <span className={styles.hashTagText2}>
                  {detailData.hashTag}
                </span>
                <Image
          ...
          <div className={styles.leftButtonContainer}>
            <button className={styles.leftButton} onClick={fixButtonHandler}>
              수정
            </button>
